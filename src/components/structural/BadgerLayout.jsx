...
export function BadgerLayout(props) {
    ...
    const [loginStatus, setLoginStatus] = useState(sessionStorage.getItem("logged_user"));
    ...
    useEffect(() => {
        ...
        if (sessionStorage.getItem("logged_user") === "" | sessionStorage.getItem("logged_user") === "\"\"") {
